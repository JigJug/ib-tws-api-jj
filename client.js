...
class Client {
  ...
  */
  ...
  async reqPnL(account/*self, requestId: int, account: str, modelCode: str*/) {
    //throw new Error('not implemented yet');
    ...
    //const reqID = await this._allocateRequestId();
    //console.log(reqID)

    //17001 is api pnl request id
    //account is account string, "ALL" doesnt work.
    //model code is empty
    //so far returns 

    await this._sendFieldsetRateLimited([OutcomeMessageType.REQ_PNL, 17001, account, ""]);
    console.log('pnl sent')
    return await this._incomeHandler.awaitMessageType(IncomeMessageType.PNL);
